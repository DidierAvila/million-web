      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <div className="text-center sm:text-left">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
            Plataforma de desarrollo web moderna con autenticación segura
          </p>
        </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg border border-blue-200 dark:border-blue-800">
          ...
          <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-2">
            <li>✅ Validación con React Hook Form y Zod</li>
            <li>✅ Manejo de errores y estados de carga</li>
            <li>✅ Diseño responsivo y accesible</li>
            <li>✅ Autenticación contra API REST</li>
            <li>✅ TypeScript y buenas prácticas</li>
          </ul>
        </div>
